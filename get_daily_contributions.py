...
# Output to CSV
filename1 = 'outputs/daily_contributions_CLG_CETES.csv'
...
# Output to CSV
filenam2 = 'outputs/daily_contributions_CLG_GBM.csv'
...
# Output to CSV
filename3 = 'outputs/daily_contributions_CLG_AllAccounts.csv'
